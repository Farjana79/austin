        ...
        if (settings.controlNav) {
            ...
            for (var i = 0; i < kids.length; i++) {
                if (settings.controlNavThumbs) {
                    ...
                    if (child.attr("data-thumb")) vars.controlNavEl.append('<a class="nivo-control" rel="' + i + '"><img alt="Image Slider" src="' + child.attr("data-thumb") + '" alt="Slider image" /></a>');
                } else {
